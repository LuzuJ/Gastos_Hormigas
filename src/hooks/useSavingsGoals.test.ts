...
// Mock de los servicios y Firebase
...
describe('Hook useSavingsGoals', () => {
  beforeEach(() => {
    ...
    vi.mocked(savingsGoalService.onSavingsGoalsUpdate).mockReturnValue(() => {});
  });
  ...
  it('debería actualizar las metas cuando se reciben datos', async () => {
    vi.mocked(savingsGoalService.onSavingsGoalsUpdate).mockImplementation((userId, callback) => {
  ...
  it('debería agregar una meta de ahorro exitosamente', async () => {
    vi.mocked(savingsGoalService.addSavingsGoal).mockResolvedValue(undefined as any);
  ...
  it('debería manejar errores al agregar meta de ahorro', async () => {
    ...
    vi.mocked(savingsGoalService.addSavingsGoal).mockRejectedValue(new Error('Database error'));
  ...
  it('debería eliminar una meta de ahorro', async () => {
    vi.mocked(savingsGoalService.deleteSavingsGoal).mockResolvedValue(undefined as any);
  ...
  it('debería agregar fondos a una meta exitosamente', async () => {
    ...
    vi.mocked(runTransaction).mockImplementation(async (db, transactionFn) => {
      return await transactionFn(mockTransaction as any);
    });

    vi.mocked(increment).mockReturnValue('MOCK_INCREMENT' as any);
    vi.mocked(doc).mockReturnValue('MOCK_DOC_REF' as any);
  ...
  it('debería quitar fondos de una meta exitosamente', async () => {
    ...
    vi.mocked(increment).mockReturnValue('MOCK_DECREMENT' as any);
  ...
  it('debería limpiar la suscripción al desmontar', () => {
    ...
    vi.mocked(savingsGoalService.onSavingsGoalsUpdate).mockReturnValue(unsubscribe);
