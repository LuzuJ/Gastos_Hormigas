...
vi.mock('../../services/financials/assetService');
vi.mock('../../services/financials/liabilityService');
...
describe('Hook useNetWorth', () => {
  beforeEach(() => {
    ...
    (assetService.onAssetsUpdate as any).mockReturnValue(() => {});
    (liabilityService.onLiabilitiesUpdate as any).mockReturnValue(() => {});
  });
  ...
  it('debería actualizar activos cuando se reciben datos', async () => {
    (assetService.onAssetsUpdate as any).mockImplementation((userId: any, callback: any) => {
      callback(mockAssets);
      return () => {};
    });
  ...
  it('debería actualizar pasivos cuando se reciben datos', async () => {
    (liabilityService.onLiabilitiesUpdate as any).mockImplementation((userId: any, callback: any) => {
  ...
  it('debería limpiar las suscripciones al desmontar', () => {
    ...
    (assetService.onAssetsUpdate as any).mockReturnValue(unsubscribeAssets);
    (liabilityService.onLiabilitiesUpdate as any).mockReturnValue(unsubscribeLiabilities);
