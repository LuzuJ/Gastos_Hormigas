...
import { Search, Calendar, Tag, Clock, TrendingUp, Archive, Filter, CalendarDays, CalendarRange, ChevronDown, SlidersHorizontal } from 'lucide-react';
  ...
  return (
    <div className={styles.container}>
      ...
      >
        ...
        <ChevronDown size={16} className={`${styles.toggleChevron} ${isFiltersOpen ? styles.open : ''}`} />
      </button>

      {/* --- Contenedor de filtros colapsable --- */}
      <div className={`${styles.filtersContent} ${isFiltersOpen ? styles.filtersOpen : ''}`}>
